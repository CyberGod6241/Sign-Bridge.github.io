    ...
    <section id="home" className="pt-32 pb-20 md:pt-40 md:pb-28 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <h1 className="text-4xl sm:text-5xl text-blue-500 md:text-6xl font-bold font-display leading-tight mb-6 relative">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="px-8 py-3 bg-primary hover:bg-secondary text-primary dark:text-white font-medium rounded-full transition-all shadow-lg hover:shadow-xl">
              Start Free Trial
            </button>
        ...
        <div className="mt-16 max-w-5xl mx-auto rounded-xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-700">
          <video src='public/video.mp4' alt="App Preview" className="w-full h-auto" autoPlay loop muted playsInline></video>
        </div>
      </div>
    </section>
  )
